...
.. |link_video_courses| raw:: html
    ...
    <a href="https://www.youtube.com/playlist?list=PLGs0VKk2DiYz8js1SJog21cDhkBqyAhC5" target="_blank">YouTubeのビデオコース</a>
...
.. |link_webhooks| raw:: html
    ...
    <a href="https://ifttt.com/maker_webhooks/settings" target="_blank">ウェブフック設定</a>
...
.. |link_Kepler_Ultimate_Kit| raw:: html
    ...
    <a href="https://www.sunfounder.com/collections/raspberry-pi-kit-for-beginner-1/products/sunfounder-raspberry-pi-pico-w-ultimate-starter-kit" target="_blank">購入リンク：Kepler Ultimate Kit</a>
